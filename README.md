...
- [개념: 거버넌스 계층 (concept-governance-layer.md)](docs/concept-governance-layer.md) — 거버넌스 개념 정의, 네이티브 `SendMessage`에 거버넌스가 없는 이유, `SendMessage`+Hook으로 거버넌스를 조화시키는 아이디어와 검토 대상 정리
